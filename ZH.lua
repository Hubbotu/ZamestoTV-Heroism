...
local translations = {
    ...
    deDE = {
ACTIVE = "Heldenfunktion",
MODE_SET_TO = "Benachrichtigungsmodus wurde auf",
STATUS_INFO = "Heldenstatus:",
...
EXPIRED_MSG = "Effekt ist abgelaufen. Wird in 10 Minuten wieder verfügbar sein!",
NOTIFY_TOGGLE = "Benachrichtigung bei Ablauf des Heldeneffekts",
ANNOUNCE_MODE = "Benachrichtigungsmodus:",
HELP_COMMANDS = "Verfügbare Befehle",
ABILITY_USED = "aktiviert:",
SPELL_CAST = "gezaubert:",
LOAD_COMPLETE = "Helden-Addon geladen",
ENABLED = "AKTIVIERT",
DISABLED = "DEAKTIVIERT",
SELF_MODE = "SELBST",
SOURCE = "Quelle",
PET_ABILITY = "Heldenfunktion durch Begleiter aktiviert",
RAID_WARNING_MODE = "Schlachtzugswarnung",
TEST_MESSAGE = "Das Addon funktioniert einwandfrei!",      
    }
}
